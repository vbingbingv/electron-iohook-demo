...
if (process.platform === 'win32') {
  if (process.arch === 'x64') {
    nativeModule = require('./build/selection-hook.win32-x64.node')
  }
  if (process.arch === 'arm') {
    nativeModule = require('./build/selection-hook.win32-arm64.node')
  }
}
if (nativeModule) {
  SelectionHook = class extends EventEmitter {
    #instance = null;
    #running = false;
